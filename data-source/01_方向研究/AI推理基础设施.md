...
| --- | --- | --- | --- | --- |
| 数据中心收入继续高速增长 | tier_1 | NVIDIA FY2027 Q1 总收入 816 亿美元、数据中心收入 752 亿美元，数据中心网络收入 148 亿美元 | high | 增强 |
| AI 收入进入规模化阶段 | tier_1 | Microsoft FY2026 Q3 披露 AI 业务年化收入运行率超过 370 亿美元 | high | 增强 |
| 云厂商继续投入 AI 基础设施 | tier_1 | Amazon Q1 2026 披露 AWS 增长并强调 Trainium、NVIDIA GPU 与 AI 基础设施投入 | high | 增强 |
| 推理从单次训练变成持续使用需求 | tier_1/tier_3 | 搜索、办公、客服、代码、多模态和 Agent 都会持续消耗推理算力 | high | 增强 |
...
| --- | --- | --- | --- | --- |
| 推理算力 | high | 推理请求量、多模态和 Agent 调用持续增长 | GPU / ASIC / 服务器 | 数据中心收入、推理芯片出货和云厂商扩容 |
| 单 token 成本 | high | 推理使用量增长但成本下降不够快 | 云平台 / 模型服务 | AI 收入能否覆盖折旧、电力和芯片成本 |
| 网络和存储 | medium_high | 集群规模扩大，节点间通信和数据访问压力上升 | 交换机 / 网卡 / 光模块 / 存储 | 数据中心网络收入、光模块和交换芯片需求 |
| 电力与散热 | high | 高密度推理集群提高机柜功率和散热压力 | 电力设备 / 液冷 / 数据中心 | 并网延迟、液冷渗透率、变压器和 UPS 订单 |
| 调度系统 | medium | 多模型、多租户和低延迟推理需求提升 | 云平台 / 推理服务 | 推理服务效率、延迟和利用率改善 |
...
| --- | --- | --- | --- | --- |
| 云厂商 | 硬件/数据中心/网络/电力 | AI 基础设施投入、GPU/自研芯片部署、数据中心扩张 | 短期/中期 | high |
| 模型厂商 | 硬件/云服务 | 推理请求量增长、长上下文和多模态需求扩大 | 中期 | medium_high |
| 企业客户 | 云服务/推理平台 | 企业 Agent、AI 搜索、AI 编程助手和办公 AI 付费渗透 | 中期 | medium |
...
| --- | --- | --- | --- | --- |
| 交易中/部分充分定价 | 推理基础设施已经成为市场主线，NVIDIA 和云厂商披露持续验证需求 | medium_high | 网络、电力、散热、调度等二级瓶颈仍可能存在预期差 | 跟踪资本开支、AI 收入、折旧、电力成本和二级瓶颈订单 |
